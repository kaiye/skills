---
name: voice-article
description: 语音口述驱动的文章创作流程。支持多段语音转录、多轮内容迭代、截图标注 review（红色=删除，黄色=修改）、封面图生成，最终输出结构化 Markdown 文章。触发场景：用户发送语音录音要写文章、说"帮我写一篇文章"、"根据这段录音整理成文章"、"我要写公众号"，或发送截图要求按标注修改文章时使用。
---
